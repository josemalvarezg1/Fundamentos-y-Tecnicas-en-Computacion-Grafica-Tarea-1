...
void model::read_obj(char *filename) {
	...
	if (models.size() - 1 == 0) {	//Plano
		...
		models[models.size() - 1].ejeY = 0.20;
	}
	else if (models.size() - 1 == 1) {	//Esfera
		models[models.size() - 1].scaleT = 0.07;
		models[models.size() - 1].ejeX = 1.51;
		models[models.size() - 1].ejeY = 0.26;
		models[models.size() - 1].ejeZ = -1.33;
		models[models.size() - 1].autoRotatingInY = true;
	}
	else if (models.size() - 1 == 2) { //Mickey
		models[models.size() - 1].scaleT = 0.44;
		models[models.size() - 1].ejeY = 0.42;
	}
	else if (models.size() - 1 == 3) { //Flash
		models[models.size() - 1].scaleT = 0.61;
		models[models.size() - 1].ejeX = 0.95;
		models[models.size() - 1].ejeY = 0.50;
		models[models.size() - 1].ejeZ = -1.23;
		models[models.size() - 1].autoTranslatingInX = true;
		models[models.size() - 1].autoTranslatingInZ = true;
	}
	else if (models.size() - 1 == 4) { //Arrow
		models[models.size() - 1].scaleT = 0.61;
		models[models.size() - 1].ejeX = 0.17;
		models[models.size() - 1].ejeY = 0.38;
		models[models.size() - 1].ejeZ = -1.23;
		models[models.size() - 1].autoTranslatingInX = true;
	}
		...
		models[models.size() - 1].ejeY = 0.61;
		models[models.size() - 1].ejeZ = -1.23;
		models[models.size() - 1].autoTranslatingInX = true;
		models[models.size() - 1].autoTranslatingInY = true;
	}
	else if (models.size() - 1 == 6) { //Spider-Man
		models[models.size() - 1].scaleT = 0.61;
		models[models.size() - 1].ejeX = 0.17;
		models[models.size() - 1].ejeY = 0.51;
		...
		models[models.size() - 1].scaleT = 0.61;
		models[models.size() - 1].ejeX = -0.71;
		models[models.size() - 1].ejeY = 0.66;
		models[models.size() - 1].ejeZ = 1.18;
		models[models.size() - 1].rotacion[0] = 0.0;
		models[models.size() - 1].rotacion[1] = 1.0;
		models[models.size() - 1].rotacion[2] = 0.0;
		...
		models[models.size() - 1].scaleT = 0.61;
		models[models.size() - 1].ejeX = 0.95;
		models[models.size() - 1].ejeY = 0.58;
		models[models.size() - 1].ejeZ = 1.18;
		models[models.size() - 1].rotacion[0] = 0.0;
		models[models.size() - 1].rotacion[1] = 1.0;
		models[models.size() - 1].rotacion[2] = 0.0;
	...
	else if (models.size() - 1 == 9) { //Pared 1
		models[models.size() - 1].scaleT = 4.5;
		models[models.size() - 1].ejeX = -0.92;
		models[models.size() - 1].ejeY = 0.13;
		models[models.size() - 1].ejeZ = -2.00;
	}
	else if (models.size() - 1 == 10) { //Pared 2
		models[models.size() - 1].scaleT = 4.5;
		models[models.size() - 1].ejeX = -0.88;
		models[models.size() - 1].ejeY = 0.13;
		...
		models[models.size() - 1].ejeY = 0.13;
		models[models.size() - 1].ejeZ = -0.33;
		models[models.size() - 1].rotacion[0] = 0.0;
		...
		models[models.size() - 1].scaleT = 4.5;
		models[models.size() - 1].ejeX = 1.97;
		models[models.size() - 1].ejeY = 0.13;
		models[models.size() - 1].ejeZ = 0.95;
		models[models.size() - 1].rotacion[0] = 0.0;
		models[models.size() - 1].rotacion[1] = 0.70;
		models[models.size() - 1].rotacion[2] = 0.0;
		models[models.size() - 1].rotacion[3] = -0.70;
	}
	else if (models.size() - 1 == 13) {	//Techo
		models[models.size() - 1].scaleT = 2.00;
		models[models.size() - 1].ejeY = 1.75;
		models[models.size() - 1].rotacion[0] = 1.0;
		models[models.size() - 1].rotacion[1] = 0.0;
		models[models.size() - 1].rotacion[2] = 0.0;
		models[models.size() - 1].rotacion[3] = 0.0;
	}
		...
		models[models.size() - 1].ejeY = 0.36;
		...
		models[models.size() - 1].rotacion[3] = 0.38;
		models[models.size() - 1].autoRotatingInX = true;
		models[models.size() - 1].autoRotatingInZ = true;
	}
...
bool model::initGlew() {
	...
	else
	{
		...
		glslProgram.addUniform("shinyPhong");
		...
		glslProgram.addUniform("F0");
		glslProgram.addUniform("roughnessOren");
		glslProgram.addUniform("roughnessCook");
		glslProgram.addUniform("albedoValue");
